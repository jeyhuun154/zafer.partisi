...
(async () => {
  ...
  function _applySocialLinks() {
    ...
    // Instagram always points to zpgenclikdarica
    if (ig) ig.href = 'https://www.instagram.com/zpgenclikdarica/';
    if (tw && links.twitter)      tw.href = links.twitter;
    // Zafer Partisi always points to zaferpartisi.org.tr
    if (zp) zp.href = 'https://www.zaferpartisi.org.tr/';
  }
  ...
  function _updateHomeUI() {
    ...
    // Dedicated bell button in header
    const bellBtn = document.getElementById('notif-bell-btn');
    if (bellBtn) bellBtn.classList.toggle('hidden', isGuest);
  }
