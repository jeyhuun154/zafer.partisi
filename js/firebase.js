...
const FirebaseService = (() => {
  ...
  async function init() {
    if (_app && _db) return; // already initialized
    try {
  ...
  async function getDoc(collection, id) {
    try {
      ...
      console.warn('[Firebase] getDoc error:', e.message);
      return null;
    }
  }
  ...
  async function getDocs(collection, ...queries) {
    ...
    try {
      ...
      console.warn('[Firebase] getDocs error:', e.message);
      return [];
    }
  }
    ...
    return ref.onSnapshot(
      snap => {
        try {
          ...
          console.warn('[Firebase] onSnapshot callback error:', e);
        }
      },
